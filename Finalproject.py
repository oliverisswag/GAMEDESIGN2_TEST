...
TITLE_FNT=pygame.font.SysFont('comicsans', 50)
...
def game():
    ...
    platform_image = pygame.image.load('Pads/Pad3.png').convert_alpha()
    #bird spritesheet
...
def game2():
    ...
    #load images
    jumpy_image = pygame.image.load('jump.png').convert_alpha()
    bg_image = pygame.image.load('bg2.jpg').convert_alpha()
...
def game3():
    ...
    #load images
    jumpy_image = pygame.image.load('jump.png').convert_alpha()
    bg_image = pygame.image.load('bg3.png').convert_alpha()
    platform_image = pygame.image.load('Pads/pad4.png').convert_alpha()
    #bird spritesheet
    bird_sheet_img = pygame.image.load('bird.png').convert_alpha()
    bird_sheet = SpriteSheet(bird_sheet_img)
...
while check:
    for case in pygame.event.get():
        if case.type==pygame.QUIT and MAIN:
            check=False
